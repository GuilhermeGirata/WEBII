                ...
                <c:forEach var="item" items="${lista}">
                    <div class="columns is-flex is-vcentered has-background-light m-2"> 
                        <div class="column is-10">
                            <p><c:out value="${item.nome}"/> - R$ <c:out value="${item.preco}"/></p>
                        </div>
                        <div class="column">
                            <a class="button is-warning is-rounded is-centered" href="<c:url value="/Roupa?acao=editar&id=${item.id}"/>">Editar</a>
                        </div>
                    </div>
                </c:forEach>
